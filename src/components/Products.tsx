...
import { starRating } from "../Helpers/utililties";
    ...
    if (multipleFilters.brand.includes(true)) {
      if (multipleFilters.brand[0]) {
        tempProducts.forEach((product) => {
          if (product.productName === "Incredible Soft Gloves")
            filteredData.push(product);
        });
      }
      if (multipleFilters.brand[1]) {
        tempProducts.forEach((product) => {
          if (product.productName === "Tasty Steel Car")
            filteredData.push(product);
        });
      }
      filter1Applied = true;
            ...
            {showBrandFilter && (
              <div>
                <div className="input_label_container">
                  ...
                  />
                  <label>Incredible Soft Gloves</label>
                </div>
                <div className="input_label_container">
                  <input
                    type="checkbox"
